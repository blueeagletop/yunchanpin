    ...
    <form action="" method="post"  class="form form-horizontal" id="form-category-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" style="width: 50%" value="{{$order->title}}" placeholder="" name="title">
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9"> <span class="select-box" style="width:150px;">
                    <select class="select" name="category_id" size="1">
                        <option value="{{$order->category_id}}" >{{$order->category}}</option>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" style="width: 50%" value="{{$order->username}}" placeholder="" name="username">
                @if($order->username == '0')
                用户不存在
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" style="width: 50%" value="{{$order->order_number}}" placeholder="" name="order_number">
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" style="width: 50%" value="{{$order->start_time}}" placeholder="" name="star_time">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>订单结束时间</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" style="width: 50%" value="{{$order->end_time}}" placeholder="" name="end_time">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>订单验证码</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" style="width: 50%" value="{{$order->code}}" placeholder="" name="code">
            </div>
        </div>
        <div class="row cl">
    ...
    $("#form-category-add").Validform({
        ...
        callback: function (form) {
            ...
            $('#form-category-add').ajaxSubmit({
                ...
                url: 'service/editOrder', // 需要提交的 url
                dataType: 'json',
                data: {
                    id: "{{$order->id}}",
