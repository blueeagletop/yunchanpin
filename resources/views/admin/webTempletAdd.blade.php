...
@section('content')
    ...
    <form action="" method="post" class="form form-horizontal" id="form-webTemplet-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-5">
                <input type="text" class="input-text" value="" placeholder="" id="url" name="img">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-2"><span class="c-red">*</span>简介：</label>
            <div class="formControls col-5">
                <input type="text" class="input-text" value="" placeholder="" id="title" name="summary">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-2"><span class="c-red">*</span>编号：</label>
            <div class="formControls col-5">
                <input type="text" class="input-text" value="" placeholder="" id="title" name="number">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-2"><span class="c-red">*</span>现价：</label>
            <div class="formControls col-5">
                <input type="text" class="input-text" value="" placeholder="" id="title" name="price">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-2"><span class="c-red">*</span>原价：</label>
            <div class="formControls col-5">
                <input type="text" class="input-text" value="" placeholder="" id="title" name="worth">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-2"><span class="c-red">*</span>预览链接：</label>
            <div class="formControls col-5">
                <input type="text" class="input-text" value="" placeholder="" id="title" name="url">
            </div>
        </div>
    ...
    $("#form-webTemplet-add").Validform({
        ...
        callback: function (form) {
            ...
            $('#form-webTemplet-add').ajaxSubmit({
                ...
                url: 'service/addWebTemplet', // 需要提交的 url
                dataType: 'json',
                data: {
