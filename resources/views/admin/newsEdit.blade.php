...
@section('content')
    ...
    <form action="" method="post" class="form form-horizontal" id="form-news-edit">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-5">
                <input type="number" class="input-text" value="{{$news->top}}" placeholder="" id="url" name="top">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-2"><span class="c-red">*</span>注释：(只在后台显示)</label>
            <div class="formControls col-5">
                <input type="text" class="input-text" value="{{$news->comment}}" placeholder="" id="title" name="comment">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-2">详细内容：</label>
            <div class="formControls col-8">
                <script name="editor" id="editor" type="text/plain" style="width:100%; height:500px;">{!! $news->detail !!}</script>
            </div>
        </div>
    ...
    $("#form-news-edit").Validform({
        ...
        callback: function (form) {
            ...
            $('#form-news-edit').ajaxSubmit({
                ...
                url: 'service/editNews', // 需要提交的 url
                dataType: 'json',
                data: {
                    id:"{{$news->id}}",
