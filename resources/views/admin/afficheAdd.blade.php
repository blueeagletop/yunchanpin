...
@section('content')
    ...
    <form action="" method="post" class="form form-horizontal" id="form-affiche-add">
        {{ csrf_field() }}
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-5">
                <input type="text" class="input-text" value="" placeholder="" id="title" name="comment">
            </div>
        </div>
        <div class="row cl">
...
<script type="text/javascript">
    ...
    $("#form-affiche-add").Validform({
        ...
        callback: function (form) {
            ...
            $('#form-affiche-add').ajaxSubmit({
                type: 'post', // 提交方式 get/post
                url: 'service/addAffiche', // 需要提交的 url
                dataType: 'json',
                data: {
